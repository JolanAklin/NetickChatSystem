...
public abstract class SenderStyler : ScriptableObject
{
    public class StylerData
    {
        ...
        ///</summary>
        public ScopeManager.Scope _target {get; private set;}

        ///<summary>
        /// The scope of the sender
        ///</summary>
        public ScopeManager.Scope _sender { get; private set; }
        ...
        public StylerData(int clientId, ScopeManager.Scope target, ScopeManager.Scope sender, bool foreignSend)
        {
            _isClient = true;
            _clientId = clientId;
            _target = target;
        ...
        ///</summary>
        public StylerData(ScopeManager.Scope target)
        {
            _isClient = false;
            _clientId = null;
            _target = target;
    ...
    public abstract StylerData GenerateData(ScopeManager.Scope target);
    public abstract StylerData GenerateData(int clientId, ScopeManager.Scope target, ScopeManager.Scope sender, bool foreignSend);
}
