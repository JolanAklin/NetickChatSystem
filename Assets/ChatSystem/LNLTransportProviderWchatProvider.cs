...
{
    [CreateAssetMenu(fileName = "LNLTransportProviderWchat", menuName = "Chat system/Transport/LiteNetLib transport provider with chat support", order = 1)]
    public class LNLTransportProviderWchatProvider : LiteNetLibTransportProvider
    {
    ...
    public class LNLTransportProviderWchat : LiteNetLibTransport, INetEventListener
    {
        ...
        new public class LNLConnection : TransportConnection, IChatTransportConnection
        {
            ...
            public LNLConnection(LNLTransportProviderWchat transport)
            {
                Transport = transport;
            }
